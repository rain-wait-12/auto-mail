package com.auto.mail.presto;

import com.auto.mail.config.HikariPoolConfig;
import com.auto.mail.config.PrestoConfig;
...
public class PrestoConnPool {
    ...
    public void initialize(){
        ...
        try {
            ...
            hikariDataSource.setUsername(prestoConfig.getUsername());
            hikariDataSource.setPassword(prestoConfig.getPassword());
